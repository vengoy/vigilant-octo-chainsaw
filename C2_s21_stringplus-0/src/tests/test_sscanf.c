...
START_TEST(uint2) {
    unsigned long long int a1 = 0, a2 = 0, b1 = 0, b2 = 0, c1 = 0, c2 = 0, d1 = 0, d2 = 0;
...
suite_sscanf(void) {
    ...
    // valgrind errror tcase_add_test(tc, strings2);
    ...
    // valgrind error  case_add_test(tc, strings_mixed1);
